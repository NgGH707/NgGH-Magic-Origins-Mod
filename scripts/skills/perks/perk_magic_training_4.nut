this.perk_magic_training_4 <- this.inherit("scripts/skills/skill", {
	m = {
		Tier = this.Const.MC_MagicTier.Adept,
		MagicSkills = [],
	},
	function create()
	{
		this.m.ID = "perk.magic_training_4";
		this.m.Name = this.Const.Strings.PerkName.MC_MagicTraining4;
		this.m.Description = this.Const.Strings.PerkDescription.MC_MagicTraining4;
		this.m.Icon = "ui/perks/perk_magic_training_4.png";
		this.m.IconMini = "perk_magic_training_4_mini";
		this.m.Overlay = "perk_magic_training_4";
