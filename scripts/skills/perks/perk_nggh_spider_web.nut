this.perk_nggh_spider_web <- ::inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = ::Const.Strings.PerkName.NggH_Spider_Web;
		this.m.Description = ::Const.Strings.PerkDescription.NggH_Spider_Web;
	...
	function getPenalty()
	{
		...
		return -1 * ::Math.max(0, ::Math.round(40 * (1 - currentFatPerc)));
