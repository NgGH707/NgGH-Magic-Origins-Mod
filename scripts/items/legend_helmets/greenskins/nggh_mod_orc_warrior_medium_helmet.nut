this.nggh_mod_orc_warrior_medium_helmet <- ::inherit("scripts/items/legend_helmets/legend_helmet", {
	m = {},
	function create()
	{
		...
		this.m.Description = "A makeshift helmet crafted from looted kettle hat of fallen foes in the past, quite durable.";
