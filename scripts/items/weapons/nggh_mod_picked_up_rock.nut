this.nggh_mod_picked_up_rock <- ::inherit("scripts/items/weapons/weapon", {
	m = {},
	function create()
	{
		this.weapon.create();
		...
		this.m.Description = "A rock you just picked up moment ago. It\'s quite heavy too.";
	...
	function getTooltip()
	{
		...
		ret.push({
			...
			text = "Disappears after being used"
		});
