this.nggh_mod_legend_greenwood_schrat_small_minion <- ::inherit("scripts/entity/tactical/nggh_mod_minion", {
	m = {},
	function create()
	{
		this.m.Type = ::Const.EntityType.LegendGreenwoodSchratSmall;
		this.m.BloodType = ::Const.BloodType.Wood;
		this.m.XP = ::Const.Tactical.Actor.LegendGreenwoodSchratSmall.XP;
	...
	function onDeath( _killer, _skill, _tile, _fatalityType )
	{
		if (_tile != null)
		{
			...
			decal = _tile.spawnDetail("bust_schrat_green_body_small_01_dead", ::Const.Tactical.DetailFlag.Corpse, flip);
