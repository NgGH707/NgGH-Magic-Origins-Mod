this.egg_rider <- this.inherit("scripts/skills/nggh_rider_skill", {
	m = {},
	function create()
	{
		this.nggh_rider_skill.create();
	...
	{
		this.nggh_rider_skill.onAfterUpdate(_properties);
	...
	{
		this.nggh_rider_skill.onUpdate(_properties);
