this.reign_of_darkness_effect <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
	...
	function getTooltip()
	{
		return [
			...
			},
			{
				...
				text = "[color=" + this.Const.UI.Color.NegativeValue + "]-5%[/color] Resolve"
			},
			{
				id = 9,
				type = "text",
			...
			},
			{
				...
				text = "More vulnerable against [color=" + this.Const.UI.Color.NegativeValue + "]Nightmare[/color]"
			}
		];
	}
