this.legend_rune_shielding <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	m = {},
	function create()
	{
	...
	function getTooltip()
	{
		...
		result.push({
			...
			text = "This item has the power of the rune sigil of Shielding:\nGrant a [color=" + this.Const.UI.Color.PositiveValue + "]Protective Barrier[/color]."
		});
		return result;
	}
