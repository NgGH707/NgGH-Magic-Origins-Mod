this.legend_named_stollwurm_scales_upgrade <- this.inherit("scripts/items/armor_upgrades/named/named_armor_upgrade", {
	m = {},
	function create()
	{
	...
	{
		this.named_armor_upgrade.onUpdateProperties(_properties);
