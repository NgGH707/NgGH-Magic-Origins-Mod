...
gt.Const.Strings.PerkDescription.MC_MagicTraining3 <- "You have trained your mind to the best of it, this helps a lot in combat. Gain a third of your base Resolve as Melee and Ranged skill, with a minimum bonus of 5. [color=" + this.Const.UI.Color.NegativeValue + "]Requiring to equip a magic staff[/color]. \n\n[color=#0b0084]From the Magic perk group[/color]";
