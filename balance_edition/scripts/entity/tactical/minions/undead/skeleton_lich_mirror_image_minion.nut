this.skeleton_lich_mirror_image_minion <- this.inherit("scripts/entity/tactical/minion", {
	m = {
		DistortTargetA = null,
	...
	function improveStats( _master )
	{
		...
		b.Hitpoints += lv;
		b.Bravery += 2 * lv;
		b.Stamina += this.Math.floor(1.5 * lv);
	...
	function onInit()
	{
		...
		this.m.Skills.add(this.new("scripts/skills/actives/mod_lightning_storm_skill"));
	}
