...
::Const.GoblinRider <- 
{
	...
	ID = [
		...
		"accessory.legend_wardog",
		"accessory.legend_warhound",
		"accessory.legend_warwolf",
		"accessory.legend_armored_wardog",
		"accessory.legend_armored_warhound",
		"accessory.armored_wolf",
		"accessory.legend_heavily_armored_warhound",
		"accessory.legend_heavily_armored_wardog",
