...
::Const.PerksCharmedUnit.AlpTree <- [
	[
	...
	[
		::Const.Perks.PerkDefs.LegendLevitate,
...
::Const.PerksCharmedUnit.DemonAlpTree <- [
	[
...
::Const.PerksCharmedUnit.WolfTree <- [
	[
...
::Const.PerksCharmedUnit.WhiteWolfTree <- [
	[
		::Const.Perks.PerkDefs.FastAdaption,
		::Const.Perks.PerkDefs.Pathfinder,
		::Const.Perks.PerkDefs.CoupDeGrace,
...
::Const.PerksCharmedUnit.NachoTree <- [
	[
		::Const.Perks.PerkDefs.FastAdaption,
		::Const.Perks.PerkDefs.Pathfinder,
		::Const.Perks.PerkDefs.SunderingStrikes,
...
::Const.PerksCharmedUnit.LindwurmTree <- [
	[
		::Const.Perks.PerkDefs.Pathfinder,
		::Const.Perks.PerkDefs.SunderingStrikes,
	],
...
::Const.PerksCharmedUnit.SchratTree <- [
	[
	...
	[
		...
		::Const.Perks.PerkDefs.LegendSpecialistShieldPush,
...
::Const.PerksCharmedUnit.SmallSchratTree <- [
	[
		::Const.Perks.PerkDefs.ShieldBash,
		::Const.Perks.PerkDefs.CripplingStrikes,
		::Const.Perks.PerkDefs.Pathfinder,
...
::Const.PerksCharmedUnit.SerpentTree <- [
	[
...
::Const.PerksCharmedUnit.SpiderTree <- [
	[
		::Const.Perks.PerkDefs.FastAdaption,
		::Const.Perks.PerkDefs.Pathfinder,
		::Const.Perks.PerkDefs.Recover,
...
::Const.PerksCharmedUnit.UnholdTree <- [
	[
...
::Const.PerksCharmedUnit.BearTree <- [
	[
		::Const.Perks.PerkDefs.Pathfinder,
		::Const.Perks.PerkDefs.Stalwart,
		::Const.Perks.PerkDefs.SunderingStrikes,
