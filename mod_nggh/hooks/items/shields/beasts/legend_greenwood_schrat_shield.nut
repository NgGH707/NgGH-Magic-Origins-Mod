::Nggh_MagicConcept.HooksMod.hook("scripts/items/shields/beasts/legend_greenwood_schrat_shield", function(q) 
{
	q.create = @(__original) function()
	{
		__original();
		m.Variants = [1];
		m.Description = "A wooden shield made out of living heartwood.";
	}
