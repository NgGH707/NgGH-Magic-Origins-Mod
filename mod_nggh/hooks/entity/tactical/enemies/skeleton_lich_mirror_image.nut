::mods_hookExactClass("entity/tactical/enemies/skeleton_lich_mirror_image", function ( obj )
{
	...
	obj.makeMiniboss <- function()
	{
		...
		this.m.Skills.add(::new("scripts/skills/perks/perk_ghost_ghastly_touch"));
		this.m.Skills.add(::new("scripts/skills/perks/perk_ghost_vanish"));

		if (("Assets" in ::World) && ::World.Assets != null && ::World.Assets.getCombatDifficulty() == ::Const.Difficulty.Legendary)
		{
			this.m.Skills.add(::new("scripts/skills/perks/perk_ghost_soul_eater"));
		}
