::Nggh_MagicConcept.HooksMod.hook("scripts/skills/actives/wardog_bite", function ( q )
{
	...
	q.create = @(__original) function()
	{
		__original();
		m.Name = "Wardog Bite";
		m.Description = "Ripping off your enemy face with your powerful dog jaw. Do poorly against armor.";
		m.Icon = "skills/active_84.png";
		m.IconDisabled = "skills/active_84_sw.png";
